...
<xsl:stylesheet version="1.0" 
        ...
        <html>
            ...
            <body>
                ...
                <header>
                    <nav>
                        <ul>
                            <li> <a href="cartol219.xml"> Donna con cane </a> </li>
                            <li> <a href="cartol226.xml"> Guiglia - Stazione Climatica - Panorama</a> </li>
                        </ul>
                    </nav>
                    <div id="introduzione">   
                        <p>
                            Questo sito è stato realizzato per il progetto del corso di Codifica di Testi a.a. 2020/2021 del corso di laurea in Informatica Umanistica. <br/>
                ...
                <section id="cartolina226">
                    <div class="cont">
                        <xsl:apply-templates select="//tei:teiCorpus[@xml:id='cart226']"/>
                    </div>
                </section>
    ...
    <xsl:template match="tei:figure">
        <div class="fronte">
            <p> <b>DESCRIZIONE E NOTE:</b><xsl:value-of select="tei:figDesc"/>
                <xsl:for-each select="tei:note">
                    <xsl:value-of select="."/>
                </xsl:for-each>
            </p>
